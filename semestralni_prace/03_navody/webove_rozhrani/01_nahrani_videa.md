...
![Otevření rozbalovacího menu nahrání videa](../../assets/screenshots/video_upload/02_video_toggle.png)

Poté, klikněte na šedé tlačítko pro výber videa a vyberte své video.

![Výběr videa](../../assets/screenshots/video_upload/03_video_choosing.png)
...
![Potvrzení výběru videa](../../assets/screenshots/video_upload/04_video_upload.png)

Nyní se objeví hláška o úspěšném nahrání a video bude připraveno k výběru v sekci níže.

![Hláška o úspěšném nahrání videa](../../assets/screenshots/video_upload/05_video_uploaded.png)
