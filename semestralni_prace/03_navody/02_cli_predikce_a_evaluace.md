# Jak spustit predikci na videu a evaluovat výsledky proti referenční hodnotě

Tento návod je určený pro podrobnější ověření systému. Postupujte podle něj tehdy, když chcete spustit predikci z příkazové řádky, získat výstupní soubory a následně je porovnat s připravenou referenční hodnotou.
...
![Placeholder: terminál se spuštěnou predikcí](../assets/screenshots/05_cli_predikce.png)
_Doplnit snímek spuštění predikce z příkazové řádky._
