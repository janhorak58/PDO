...
Webové rozhraní zpřístupňuje hlavní funkce systému uživateli bez nutnosti pracovat pouze v příkazové řádce. Umožňuje vybrat vstupní data, spustit běh a následně pohodlně zkontrolovat výsledky.
