...
Výstupem zpracování není jen samotný výsledek počítání. Systém ukládá také pomocné soubory, které usnadňují kontrolu správnosti a pozdější evaluaci. Uživatel tak může pracovat jak s finálními počty, tak s průběhovými logy nebo s anotovaným videem.
